...
import { SiswaFormData } from "@/types/siswa";

interface TambahSiswaModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (data: SiswaFormData) => void;
  kelasOptions?: string[];
}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 px-3.5 py-2.5 text-xs text-slate-800 placeholder-slate-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-500/10 focus:outline-none transition bg-white"
                />
              </div>
            </div>
